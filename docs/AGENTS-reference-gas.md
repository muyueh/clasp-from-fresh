...
在動手寫任何 GAS 之前，**先打開 `shared/google-apps-script-api-reference/` 並完成以下「Reference Check」**：
...
如果你不確定某個 API 名稱 / 參數 / manifest 格式，請把 reference library 和下面的官方 / 範例資源當作唯一真實來源。
